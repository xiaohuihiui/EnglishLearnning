...
if __name__ == "__main__":
    # 路径确保正确 (原生字符串 r"...")
    my_input_dir = r"D:\TOEIC\1やり直し英語Eigo Chat Lab! TOEICとその一歩先の英語へ\TOEIC Part2対策リスニング練習問題"
    my_output_dir = r"D:\TOEIC\1やり直し英語Eigo Chat Lab! TOEICとその一歩先の英語へ\TOEIC Part2対策リスニング練習問題"
